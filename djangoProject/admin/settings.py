...
SECRET_KEY = "django-insecure-^$dz26r3-ffemd&(nz=pww+s6u7nr+=_olyba4)a7u3$li2+_p"
...
INSTALLED_APPS = [
    ...
    "multiplex.cinemas","multiplex.movies","multiplex.muser","multiplex.showtimes","multiplex.theaters","multiplex.theater_tickets",
